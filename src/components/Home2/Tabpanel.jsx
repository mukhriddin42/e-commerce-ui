...
const Tabpanel = () => {
  ...
  return (
    <div className="hidden md:block w-full overflow-hidden">
      <div
        className={`container m-auto mt-3 relative h-[400px] md:h-[450px] lg:h-[500px] bg-cover bg-center rounded-3xl transition-all duration-700 ${slides[currentSlide].bg}`}
      >
        <div className="absolute inset-0 rounded-3xl flex flex-col justify-start items-start py-20 md:py-28 px-4 md:px-10 ml-6 md:ml-10">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-gray-800">
            {slides[currentSlide].title}
          </h2>
          <h3 className="text-2xl md:text-4xl lg:text-5xl font-semibold text-gray-700 mt-2">
          ...
          <div className="mt-6 flex items-center gap-2 bg-white rounded-full shadow-md">
            <LuSend className="text-gray-500 ml-5" size={20} />
            <input
              type="email"
              placeholder="Your email address"
              className="outline-none px-2 py-2 md:px-3 md:py-3 lg:py-4 rounded-full text-sm w-[120px] md:w-[200px] lg:w-[220px]"
            />
            <button className="bg-[#3BB77E] hover:bg-[#3BB16E] cursor-pointer text-white text-sm px-4 py-2 md:px-5 md:py-3 lg:py-4 rounded-full">
              Subscribe
            </button>
          </div>
        </div>
